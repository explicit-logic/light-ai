...
import { customCmakeOptionsEnvVarPrefix } from '../../config';

export function resolveCustomCmakeOptions(customCmakeOptions?: Record<string, string>) {
  const newCustomCmakeOptions: Map<string, string> = customCmakeOptions == null ? new Map() : new Map(Object.entries(customCmakeOptions));
