...
export class GeneralChatWrapper extends ChatWrapper {
        ...
        return LlamaText([
          ...
          model.values.length === 0 && !isLastItem
            ...
            : LlamaText([
                ...
                model,
                isLastItem ? LlamaText([]) : SpecialTokensText.wrapIf(this._allowSpecialTokensInTitles, '\n\n'),
              ]),
        ]);
      }),
    );
  ...
  public static override _getOptionConfigurationsToTestIfCanSupersedeJinjaTemplate() {
    return [{}, { allowSpecialTokensInTitles: true }] satisfies ChatWrapperJinjaMatchConfiguration<typeof this>;
  }
}
