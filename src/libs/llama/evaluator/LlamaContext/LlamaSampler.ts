...
export class LlamaSampler {
  ...
  /** @internal */ public disposed = false;
  ...
  /** @internal */
  public static _canBeNextTokenForGrammarEvaluationState(llama: Llama, grammarEvaluationState: LlamaGrammarEvaluationState, token: Token) {
    return llama._bindings.AddonSampler.canBeNextTokenForGrammarEvaluationState(grammarEvaluationState._state, token);
  }

  /** @internal */
  public static _acceptTokenOnGrammarEvaluationState(llama: Llama, grammarEvaluationState: LlamaGrammarEvaluationState, token: Token) {
