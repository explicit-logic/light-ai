import type { AddonGrammarEvaluationState } from '../bindings/AddonTypes.js';
...
export class LlamaGrammarEvaluationState {
  ...
  public constructor({ model, grammar }: LlamaGrammarEvaluationStateOptions) {
    ...
    if (model._llama !== grammar._llama) throw new Error('The given LlamaModel and LlamaGrammar must be from the same Llama instance');
