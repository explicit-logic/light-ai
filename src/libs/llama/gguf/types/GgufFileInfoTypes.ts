import type { MergeOptionalUnionTypes } from '../../utils/mergeUnionTypes';
import type { GgufFileReader } from '../fileReaders/GgufFileReader.js';
import type { GgufReadOffset } from '../utils/GgufReadOffset';
import type { GgufArchitectureType, GgufMetadata } from './GgufMetadataTypes';
import type { GgufTensorInfo } from './GgufTensorInfoTypes';
