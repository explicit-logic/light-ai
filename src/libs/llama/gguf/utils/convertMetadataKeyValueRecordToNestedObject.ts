...
import type { MetadataKeyValueRecord, MetadataNestedObject, MetadataValue } from '../types/GgufFileInfoTypes.js';
...
export function convertMetadataKeyValueRecordToNestedObject(
  ...
  for (const [key, value] of Object.entries(keyValueRecord)) {
    if (ignoreKeySet.has(key)) continue;
